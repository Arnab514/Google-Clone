...
const VoiceSearchPage = ({ 
  ...
  // Watch for when listening stops and there's a transcript
  useEffect(() => {
    let timeoutId;
    
    // If we have a transcript and we're not listening anymore
    if (transcript && !isListening) {
      console.log("Speech stopped, preparing to search...");
      timeoutId = setTimeout(() => {
        console.log("Executing search with:", transcript);
